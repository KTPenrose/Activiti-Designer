...
public class ActivitiResourceSelectionDialog extends SelectionDialog {
   ...
   /**
    * Creates a new instance of the class. When this constructor is used to create the dialog, resources will be gathered dynamically as the pattern string is specified. Only resources of the given
    * types that match the pattern string will be listed. To further filter the matching resources,
    * 
    ...
    */
   public ActivitiResourceSelectionDialog(Shell parentShell, IContainer container, int typeMask) {
      super(parentShell);
   ...
   /**
    * Returns whether to include a "Show derived resources" checkbox in the dialog. The default is <code>false</code>.
    *
   ...
   /**
    * Use a binary search to get the first match for the patternString. This method assumes the patternString does not contain any '?' characters and that it contains only one '*' character at the end
    * of the string.
    */
   ...
   /**
    * Use a binary search to get the last match for the patternString. This method assumes the patternString does not contain any '?' characters and that it contains only one '*' character at the end
    * of the string.
    */
   ...
   /**
    * Gather the resources of the specified type that match the current pattern string. Gather the resources using the proxy visitor since this is quicker than getting the entire resource.
    *
   ...
   /**
    * Returns whether derived resources should be shown in the list. The default is <code>false</code>.
    *
   ...
   /**
    * Use this method to further filter resources. As resources are gathered, if a resource matches the current pattern string, this method will be called. If this method answers false, the resource
    * will not be included in the list of matches and the resource's children will NOT be considered for matching.
    */
    ...
    *
    * @param force if <code>true</code> a refresh is forced, if <code>false</code> a refresh only occurs if the pattern has changed
    *
    * @since 3.1
    */
   ...
   /**
    * Update the specified item with the new info from the resource descriptor. Create a new table item if there is no item.
    *
